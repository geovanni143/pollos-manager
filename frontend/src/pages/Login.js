    ...
    <div className="min-h-screen bg-gradient-to-br from-yellow-50 to-orange-100 flex justify-center items-center p-4">
      <div className="bg-white shadow-md rounded-xl w-full max-w-sm p-6 text-center">
        ...
        <div className="mt-4 space-y-2">
          <button
            onClick={() => navigate("/empleados", { state: { rolDefault: "empleado" } })}
            className="w-full border border-yellow-500 text-yellow-600 py-2 rounded-md text-sm font-medium hover:bg-yellow-100"
          >
            REGISTRARSE
          </button>
          <button
          ...
          <button
            ...
            className="w-full text-yellow-600 text-sm hover:underline"
          >
